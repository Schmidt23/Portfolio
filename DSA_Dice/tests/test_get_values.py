...
@pytest.mark.parametrize("skill_points, exception",[
    ("abc", ValueError),
     (None, TypeError),
     ([1,2,3], TypeError)
...
def test_invalid_skill_points(default_skill_list, skill_points, exception):
    #arrange
    character = {"Skillpoints": {"Riding": skill_points}, "Attributes": {"STR": "10", "DEX": "10", "CON": "10"}}
...
@pytest.mark.parametrize("attribute, exception",[
    ("abc", ValueError),
     (None, TypeError),
     ([1,2,3], TypeError),
], ids=["string", "None", "List"])
def test_invalid_attributes(default_skill_list, attribute, exception):
    #arrange
    character = {"Skillpoints": {"Riding": "5"}, "Attributes": {"STR": attribute, "DEX": "10", "CON": "10"}}
    skill_list = default_skill_list
...
def test_attribute_key(default_skill_list):
    #arrange
    character = {"Skillpoints": {"Riding": "5"}, "Attributes": {"non_existant": "10", "DEX": "10", "CON": "10"}}
    skill_list = default_skill_list
...
def test_skill_key(default_skill_list):
    #arrange
    character = {"Skillpoints": {"non_existant": "5"}, "Attributes": {"STR": "10", "DEX": "10", "CON": "10"}}
    skill_list = default_skill_list
...
def test_return_successful(default_skill_list):
    #arrange
    character = {"Skillpoints": {"Riding": "5"}, "Attributes": {"STR": "10", "DEX": "10", "CON": "10"}}
    skill_list = default_skill_list
